		...
		if (menu_event.type == SDL_QUIT) {
			...
			if (menu_event.key.keysym.sym == SDLK_ESCAPE) {
				...
				case 0: //continue campaign
					{
						player = new Player(base_lives, base_level, 380, 600, 580, 590);
				...
				case 1: //start campaign
					{
						player = new Player(lives_at_beginning, 1, 380, 600, 580, 590);
				...
				case 2: // select 1 level
					{
						player = new Player(lives_at_beginning, level_to_play, 380, 600, 580, 590);
