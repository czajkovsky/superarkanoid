...
*/
	...
	source = IMG_Load("res/img/b_green00.png");
	SDL_Surface *img_block = SDL_DisplayFormatAlpha(source);

	source = IMG_Load("res/img/b_green01.png");
	SDL_Surface *img_block1 = SDL_DisplayFormatAlpha(source);
...
//			bl.print();
			...
			if(bl.get_type()==1) SDL_BlitSurface(img_block1, &clip, screen, &offset);
			else SDL_BlitSurface(img_block, &clip, screen, &offset);
