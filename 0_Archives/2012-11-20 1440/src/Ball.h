...
class Ball {
	public:
		...
		int move(vector<Block> &blocks, vector<Border> &borders, vector<Bonus> &bonuses, Platform &plat, int blocksuntouched[], int &blocks_left, int &new_points); //zwraca 1 jeśli trzeba usunąć piłkę i nie było kolizji,
